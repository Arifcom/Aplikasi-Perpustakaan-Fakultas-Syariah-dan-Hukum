            ...
            <div class="header">
                <div class="row">
                    <div class="form-group">
                        <div class="col-md-2">
                            <a href="#" data-toggle="modal" data-target="#tambah-buku-tamu" class="btn btn-default btn-fill btn-wd">Tambah</a>
                        </div>
                        <div class="col-md-10">
                ...
                <div class="row">
                    <form  action="<?php echo BASE_URL; ?>bukutamu/cari" method="post">
                        <div class="form-group">
                            <div class="col-md-2">
