            ...
            <div class="sidebar" data-background-color="white" data-active-color="danger">
                ...
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        ...
                        <li <?php if ($active == "buku") { echo "class='active'"; } ?>>
                            <a href="<?php echo BASE_URL; ?>buku">
                                <i class="ti-book"></i>
                                <p>Buku</p>
                            </a>
                        </li>
                        <li <?php if ($active == "pegawai") { echo "class='active'"; } ?>>
                            <a href="<?php echo BASE_URL; ?>pegawai">
                                <i class="ti-user"></i>
                                <p>Pegawai</p>
                            </a>
                        </li>
                        <li <?php if ($active == "mahasiswa") { echo "class='active'"; } ?>>
                            <a href="<?php echo BASE_URL; ?>mahasiswa">
                                <i class="ti-user"></i>
                                <p>Mahasiswa</p>
                            </a>
                        </li>
                        <li <?php if ($active == "peminjaman") { echo "class='active'"; } ?>>
                            <a href="<?php echo BASE_URL; ?>peminjaman/monitor">
                                <i class="ti-split-h"></i>
                                <p>Peminjaman</p>
                            </a>
                        </li>
                        <li <?php if ($active == "pengembalian") { echo "class='active'"; } ?>>
                            <a href="<?php echo BASE_URL; ?>pengembalian/monitor">
                                <i class="ti-split-h"></i>
                                <p>Pengembalian</p>
                            </a>
                        </li>
                        <li <?php if ($active == "perpanjangan") { echo "class='active'"; } ?>>
                            <a href="<?php echo BASE_URL; ?>perpanjangan/monitor">
                                <i class="ti-split-h"></i>
                                <p>Perpanjangan</p>
                            </a>
                        </li>
                        <li <?php if ($active == "denda") { echo "class='active'"; } ?>>
                            <a href="<?php echo BASE_URL; ?>denda">
                                <i class="ti-money"></i>
                                <p>Denda</p>
                            </a>
                        </li>
        ...
        <div class="modal-dialog">
            <div class="pop-up-container">
                ...
                <form  action="<?php echo BASE_URL; ?>pegawai/tambah" method="post">
                    <input type="text" name="nip" placeholder="NIP" class="form-control border-input" autofocus>
                    <input type="text" name="nama" placeholder="Nama" class="form-control border-input">
                    <input type="text" name="jabatan" placeholder="Jabatan" class="form-control border-input">
